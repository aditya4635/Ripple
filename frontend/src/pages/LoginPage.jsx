  ...
  return (
    ...
    <div className="h-screen grid lg:grid-cols-2 z-11">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8 bg-blue-100 px-20 py-10 rounded-lg   ">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2 text-black">Welcome Back</h1>
              <p className="text-base-content/60 text-black">Sign in to your account</p>
            </div>
          </div>
