  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <button
          onClick={handleClose}
          className="fixed top-6 right-6 p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors z-50 backdrop-blur-sm"
        >
        ...
        <button
          ...
          className="fixed top-6 right-20 p-3 bg-white/10 hover:bg-white/20 rounded-full transition-colors z-50 backdrop-blur-sm"
