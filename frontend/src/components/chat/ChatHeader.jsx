...
const ChatHeader = () => {
  const { selectedUser, setSelectedUser, typingUsers, deleteChatHistory } = useChatStore();
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Avatar
              ...
              className="hover:ring-2 hover:ring-primary/30 transition-all hover:shadow-lg rounded-full"
            />
          ...
          <div className="flex items-center gap-2">
             <button 
               onClick={() => {
                   useVideoCallStore.getState().setCallState("calling");
               }} 
        ...
        <div className="modal-box">
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button onClick={() => deleteChatHistory(selectedUser._id)} className="btn btn-error">Clear Chat</button>
            </form>
          </div>
        </div>
