...
const Sidebar = () => {
  const { getUsers, users, selectedUser, setSelectedUser, isUsersLoading, isAIChatSelected, setAIChatSelected, markAsRead } = useChatStore();
      ...
      <div className="overflow-y-auto w-full py-3 px-2 space-y-1 custom-scrollbar">
        <button
          ...
          className={`
            ...
            ${isAIChatSelected ? "bg-primary/10 ring-2 ring-primary/30 shadow-glass backdrop-blur-md" : ""}
          `}
        >
